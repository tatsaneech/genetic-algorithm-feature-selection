...
%	variance, and the test data using the mean and standard deviation of 
...
%       'normal'    1   Normalize to have zero mean and unit variance
%       'onesided'  2   Normalize a one-sided distribution (e.g. SpO2)
%       otherwise       Default zero mean, unit variance
%
%	Inputs:
...
if nargin<3
    % Default use zero mean/unit variance
...
%=== Extract training data mean and variance
mu=mean(training,1);
sigma=var(training,[],1);
...
%=== Zero mean unit variance (default normalization)
