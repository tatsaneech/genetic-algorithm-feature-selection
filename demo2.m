...
opts=ga_opt_set('Parallelize',0,'CostFcn',@cost_AUROC,'OptDir',1,...
    'ErrorIterations',20,'ErrorGradient',0.005,'MutationRate',0.20,...
    'PopulationSize', 20,'FitnessFcn','fit_LR','NumActiveFeatures',20,...
    'Repetitions', 1,'MaxIterations',100,'Display','plot');
